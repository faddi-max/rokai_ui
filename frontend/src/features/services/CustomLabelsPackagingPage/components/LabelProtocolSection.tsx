...
const DEFAULT_PARAGRAPHS = [
  "Custom Labeling & Packaging at Rokai allows brands to create a consistent and professional product presentation. From labels and packaging details to brand-specific requirements, every element can be developed around your identity.",
  "Our approach combines practical packaging requirements with a clear visual system, helping your products arrive ready to represent your brand.",
];
...
export default function LabelProtocolSection({
  eyebrow = "The Identity Advantage",
  title = "THE ROKAI",
  highlight = "PRESENTATION Protocol.",
  headerDescription = "Rokai brings labeling and packaging into the same brand system, creating a clear and consistent identity across every product.",
