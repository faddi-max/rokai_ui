...
export default function LabelOverviewSection({
  eyebrow = "Custom Labeling & Packaging",
  title = "WHAT IS CUSTOM",
  highlight = "Labeling & Packaging",
  headerDescription = "Rokai provides custom labeling and packaging solutions designed to support your brand identity and product presentation.",
  image,
