...
export default function HeroSection() {
  return (
    <section className="relative bg-black overflow-hidden pb-8 lg:pb-0">
      <div className="relative mx-auto grid max-w-[1512px] items-center gap-8 px-5 py-10 sm:px-8 md:px-10 lg:grid-cols-2 lg:gap-5 lg:px-16 lg:pt-14">
        <div className="flex min-w-0 flex-col gap-6">
          <h1 className="font-space-grotesk text-[clamp(2rem,9vw,3.5rem)] font-bold leading-[1.02] text-white uppercase lg:text-[70px] lg:leading-[68px]">
          ...
          <p className="font-space-grotesk text-white/80 text-base max-w-md">
        ...
        <div className="relative flex w-full items-end justify-center gap-8 lg:gap-15">
          ...
          <div className="relative z-10 w-full max-w-[320px] sm:max-w-[420px] lg:max-w-[480px] lg:-translate-x-10">
            ...
            <div className="absolute -top-1 right-0 flex w-[112px] flex-col rounded-md bg-white p-2.5 shadow-lg sm:-top-4 sm:-right-10 sm:w-[140px] sm:p-3 lg:-right-24">
              <img
          ...
          <div className="relative z-10 mb-16 hidden flex-col items-start gap-2 lg:flex">
